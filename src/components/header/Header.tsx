...
function Header() {
  return (
    <div className="  max-w-3xl w-full h-fit">
      <div className="relative pt-8  flex flex-col gap-2  justify-start w-full items-start !overflow-hidden">
        <img
        ...
        <h4 className={`text-gray-500 ${pixel.className} `}>
          Software Engineer
        </h4>

        <div className="text-gray-500 flex gap-2 text-sm items-center cursor-pointer">
          <div>
            <svg
              width="15"
              height="15"
          ...
          <div
            onClick={() => {
              window.open(
                "https://maps.app.goo.gl/2KRVKcvxkdWuTWTf9",
                "_blank"
              );
            }}
        ...
        <div className="flex gap-3 mt-4">
          ...
          <motion.div
            ...
            whileTap={{ scale: 0.95 }}
          >
            <a href="mailto:ajaykumar04122000@gmail.com">
              <EnvelopeClosedIcon className="h-6 w-6 shrink-0  transition-transform duration-200" />
            </a>
          </motion.div>
        </div>
