    ...
    <Layout>
      <div className="pt-8 max-w-3xl w-full h-full">
          ...
          <li className="border-l-2 border-gray-300">
            <div className="flex flex-start">
              ...
              <div className="h-[100px] px-2 md:px-4 text-md text-gray-600">
                ...
                <br />
                <div className="text-xs mt-2 ">July 2021 - April 2022</div>
              </div>
            </div>
          </li>
          <li className="">
        ...
        <div className="grid  grid-cols-1 gap-3  md:grid-cols-3">
          ...
          <motion.div
            onClick={() =>
              window.open("https://github.com/kumarajay0412/Clear-UI", "_blank")
            }
            whileHover={{
              y: -10, // Move up by 10 pixels
              transition: {
          ...
          >
            ...
            <div className="text-md text-gray-600">Clear UI</div>
            <div className="text-xs text-gray-500">
              A list of components with great animation and ready to use in
              production
            </div>
          </motion.div>
          <motion.div
          ...
          >
            ...
            <div className="text-xs text-gray-500">
              ...
              for Delhi Goverment and Delhi metro
            </div>
          </motion.div>
          <motion.div
            onClick={() =>
